...
| [0028](0028-aws-account-and-security-baseline.md) | Cuentas de AWS dedicadas, entornos y línea base de seguridad | Aceptada; nota del 2026-09-25: el usuario descarta la organización y las cuentas miembro, y 0034 (aceptada) la sustituye en parte |
...
| [0032](0032-backups-and-restore.md) | Copias de seguridad y restauración del libro | Aceptada; nota del 2026-09-25 (cuenta compartida, ADR-0034: el ensayo de pérdida de la cuenta pasa a destruir y levantar `dev`) |
| [0033](0033-console-device-token.md) | Acceso de la consola a la API: token de dispositivo emitido al final de un inicio de sesión que abre la propia consola | Aceptada (2026-09-25), por delegación expresa del usuario sobre el inicio de sesión; emisión solo desde la consola, 90 días con techo fijo de 120, `credentials.json`, SSM, identificador sin selector de versión, registro sin caché, firmas separadas por HKDF; nota del 2026-09-25 (cuenta compartida, ADR-0034: registros en prefijos de la misma cuenta, cupos de SSM y KMS compartidos); nota del 2026-09-25 (bloque 0 de la 015: `mfa_required` no se emite) |
| [0034](0034-shared-aws-account.md) | Despliegue en una cuenta de AWS compartida con otros proyectos | **Aceptada (2026-09-25)** por la dirección, desarrollando la decisión del usuario del mismo día; el usuario puede revocarla; tres rondas de revisión adversarial (PR #87). Sustituye en parte a 0028 (organización y cuentas miembro, SCP, *trail* propio, administración desde la cuenta de gestión, salvaguarda del *sandbox* de SES, *bootstrap* por cuenta), tras la decisión del usuario del mismo día de no crear organización |
