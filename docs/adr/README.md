...
| [0034](0034-shared-aws-account.md) | Despliegue en una cuenta de AWS compartida con otros proyectos | **Propuesta** (2026-09-25). Sustituye en parte a 0028 (organización y cuentas miembro, SCP, *trail* propio, administración desde la cuenta de gestión, salvaguarda del *sandbox* de SES, *bootstrap* por cuenta), tras la decisión del usuario del mismo día de no crear organización |
