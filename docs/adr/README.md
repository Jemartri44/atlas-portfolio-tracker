...
| ADR | Título | Estado |
|---|---|---|
| [0001](0001-backend-language.md) | Lenguaje del backend y del dominio | Propuesta |
| [0002](0002-ledger-storage.md) | Almacenamiento del libro mayor | Propuesta |
| [0003](0003-append-only-ledger.md) | Libro mayor append-only con lotes como proyección | Propuesta |
