...
| [0033](0033-console-device-token.md) | Acceso de la consola a la API: token de dispositivo emitido al final de un inicio de sesión que abre la propia consola | Propuesta (2026-09-25); revisada el mismo día (emisión solo desde la consola, 90 días, `credentials.json`, SSM) y con la verificación de seguridad incorporada (identificador sin selector de versión, registro sin caché, firmas separadas por HKDF); pendiente de que el usuario la acepte |
