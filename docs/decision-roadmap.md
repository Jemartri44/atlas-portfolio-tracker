...
- **La regla de `gitleaks` para el prefijo del token de la consola** (ADR-0033, punto 1): se propone al usuario, que decide sobre las herramientas. No estaba en su lista.
