...
| — | *Web, segunda mitad: feature `007-web-analytics`* | Pulido visual | `docs/prompts/007-web-analytics.md` | **Prompt escrito** 2026-09-18. Recoge los dos cabos sueltos de la 006 (`transfer_max_days` sin consumir —ahora regla de dominio, decisión (c)— y uPlot por vendorizar) y añade, a petición del usuario, calidad del frontend (techo de 250 líneas por fichero, componentes reutilizados) y manejo de errores a partir del inventario de la 006 |
