...
| — | *Web, primera mitad: feature `006-web-shell`* | Web (2.ª mitad) | `docs/prompts/006-web-shell.md`, ADR-0017, ADR-0019 | En implementación desde 2026-09-18 |
| — | *Web, segunda mitad* | Pulido visual | Prompt por escribir | Pendiente. Recoge además dos cabos sueltos detectados en la 006: `transfer_max_days` existe en `Settings` y **nadie lo consume** (marcar un traspaso retrasado es una regla de negocio nueva), y uPlot se vendoriza cuando lleguen las gráficas |
