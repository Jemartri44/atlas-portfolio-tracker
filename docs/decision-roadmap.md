...
- `docs/data-schema.md` §1 (`prices/symbols.json`, `reference/ecb/` en local, `sync/devices/`), §4, §5 (operaciones del puerto sobre líneas crudas), §6.2 (`broker_settled_eur`) y §6.3 (una sola corrección viva).
