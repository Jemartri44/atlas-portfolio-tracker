...
- **Elegir tipo**: «Del día a día» en un mosaico de baldosas a un toque, dos columnas en el móvil y cuatro en escritorio; debajo, los grupos restantes plegados. **Las listas de compra y de orden no ofrecen activos dados de baja ni uno que una fusión o un cambio de clase convirtió en otro y ya no tiene nada** (la misma regla que los pesos objetivo, `view-models/weighted.ts`); la venta y la valoración conservan sus listas.
