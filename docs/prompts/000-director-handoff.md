...
- **Los criterios fiscales están fijados** en `docs/fiscal-questions.md` —**24**—, con su fundamento, **su grado de certeza** y **la dirección del riesgo**, por la dirección y sin asesor. **Seis siguen en disputa** y sin resolver (#2, #4, #7, #8, #13 y #15), y los dudosos **no** son todos conservadores (§7). El catálogo del código tiene **33 identificadores** para esos 24, porque el #2 y el #24 llevan una variante por lectura posible: **un identificador de criterio nunca cambia de significado**, así que una lectura nueva estrena identificador.
