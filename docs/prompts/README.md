...
| [003](003-synthetic-data.md) | Datos sintéticos y *golden file*, `compact` con archivo del original, migración de prueba v1→v2, `integrity` completa (`check --deep`), `atlas backup`, tooling | Escrito 2026-08-30; pendiente de implementar |
