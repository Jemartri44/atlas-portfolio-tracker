...
| [010](010-tax-output.md) | Fase 5, salida fiscal: `tax_return_filed` (ADR-0020), la Renta por casillas como datos por ejercicio, los Modelos 720 y 721 fuera de `tax/`, la pantalla fiscal de la web y la CLI | Listo para el implementador: las siete preguntas de su redacción, respondidas en §7 (2026-09-19, PR #60), con enmienda de ADR-0020, el criterio #11 corregido y el criterio #24 (ETC y ETP como rendimiento del capital mobiliario, con su nuevo valor por defecto en el bloque 0). Requiere la 009 y el rediseño fusionados |
