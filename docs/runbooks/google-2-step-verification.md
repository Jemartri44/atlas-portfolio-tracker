...
Y Atlas **no puede comprobar** que esa cuenta tenga la verificación en dos pasos activada, ni impedir que Google recuerde un navegador (ADR-0027, «Lo que se pierde frente a Cognito»). Por eso tenerla activada es un **requisito tuyo**, previo al despliegue (`docs/decision-roadmap.md`, Ronda 8, «Plan por etapas», etapa 3). Esta guía te lleva por ella en unos 20 minutos.
