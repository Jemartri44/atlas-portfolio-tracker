...
- [X] T026 Abrir la PR `feature/002-corporate-actions` → `develop` con `.github/pull_request_template.md`, checklist honesta, descripción en inglés; esperar CI. **No fusionar.** — PR #15 abierta el 2026-08-30
